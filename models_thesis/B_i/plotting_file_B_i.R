...
file_B_I_500 <- read.delim('TF_i_500/B_i_results_500.E.out', col.names = c('time','TR','TR_p','activator','activator_p',
...
file_B_I_50 <- read.delim('TF_i_50/B_i_results_50.E.out', col.names = c('time','TR','TR_p','activator','activator_p','inhibitor',
